(function(window) {
  ...
  const KEYS = Object.freeze({
    ...
    stockCategories: 'tw_stock_categories_by_code_v1',
    categoryMaster: 'tw_stock_category_master_v1',
  ...
  function normalizeBackupPayload(payload, currentState = {}) {
    ...
    return {
      ...
      stockCategories: normalizeObject(payload[fields.stockCategories] || currentState.stockCategories),
      categoryMaster: window.StockCategoryService ? window.StockCategoryService.normalizeMaster(payload[fields.categoryMaster] || currentState.categoryMaster) : normalizeObject(payload[fields.categoryMaster] || currentState.categoryMaster),
  ...
  function buildBackupPayload(state) {
    ...
    return {
      ...
      [fields.stockCategories]: normalizeObject(state.stockCategories),
      [fields.categoryMaster]: window.StockCategoryService ? window.StockCategoryService.normalizeMaster(state.categoryMaster) : normalizeObject(state.categoryMaster),
    };
  }
  ...
  function saveCoreData(state) {
    ...
    setJSON('stockCategories', normalizeObject(state.stockCategories));
    setJSON('categoryMaster', window.StockCategoryService ? window.StockCategoryService.normalizeMaster(state.categoryMaster) : normalizeObject(state.categoryMaster));
  ...
  function applyBackupPayload(payload, vm) {
    ...
    vm.stockCategories = normalized.stockCategories;
    vm.categoryMaster = normalized.categoryMaster;
  ...
  function loadInitialState() {
    ...
    return {
      ...
      stockCategories: normalizeObject(getJSON('stockCategories', {})),
      categoryMaster: window.StockCategoryService ? window.StockCategoryService.normalizeMaster(getJSON('categoryMaster', null)) : normalizeObject(getJSON('categoryMaster', {})),
