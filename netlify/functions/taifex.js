/**
 * Netlify Function: taifex
 * CORS-safe proxy for TAIFEX endpoints used by the app.
 *
 * Usage:
 *   /.netlify/functions/taifex?u=<ENCODED_URL>
 *
 * Security:
...
exports.handler = async (event) => {
  ...
  if (!ALLOWED_HOSTS.has(url.host) && !url.host.endsWith(".taifex.com.tw")) {
